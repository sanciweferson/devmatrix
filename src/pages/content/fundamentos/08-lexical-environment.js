      ...
      <button class="code-block__copy" type="button">
        <span class="code-block__copy-icon">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
            ...
            <path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 0 2 2"/>
          </svg>
        </span>
...
<span class="syn-keyword">function</span> <span class="syn-fn">executar</span>() {
  <span class="syn-keyword">const</span> ambiente = <span class="syn-string">"desenvolvimento"</span>   <span class="syn-comment">// escopo local</span>
  configurar()   <span class="syn-comment">// chamada de dentro de executar()</span>
}
...
executar()</code></pre>
  ...
  <div class="code-console">
    <div class="code-console__line">
      ...
      <span class="syn-output">"produção"</span>
    </div>
  </div>
      ...
      <button class="code-block__copy" type="button">
        <span class="code-block__copy-icon">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
            ...
            stroke-linecap="round" stroke-linejoin="round">
            <rect width="14" height="14" x="8" y="8" rx="2"/>
            <path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 2 2 2"/>
          </svg>
        </span>
        <span class="code-block__copy-label">Copiar</span>
      </button>
...
<span class="syn-keyword">function</span> <span class="syn-fn">exibirProduto</span>(<span class="syn-id">nome</span>) {
  <span class="syn-keyword">const</span> preco = <span class="syn-number">99.90</span>
  console.log(<span class="syn-string">\`[</span>${loja}<span class="syn-string">] </span>${nome}<span class="syn-string">: R$ </span>${preco}<span class="syn-string">\`</span>)
}

exibirProduto(<span class="syn-string">"Notebook"</span>)
...
*/</code></pre>
  ...
  <div class="code-console">
    <div class="code-console__line">
      ...
      <span class="code-console__arrow">→</span>
      <span class="syn-output">"[Scriptorium] Notebook: R$ 99.90"</span>
    </div>
  </div>
</section>
...
<span class="syn-keyword">function</span> <span class="syn-fn">externo</span>() {
  <span class="syn-keyword">const</span> nivel2 = <span class="syn-string">"externo"</span>

  <span class="syn-keyword">function</span> <span class="syn-fn">interno</span>() {
    <span class="syn-keyword">const</span> nivel3 = <span class="syn-string">"interno"</span>

    <span class="syn-comment">// interno() enxerga os três níveis</span>
    console.log(nivel3)   <span class="syn-comment">// encontra no próprio escopo</span>
    console.log(nivel2)   <span class="syn-comment">// sobe um nível — encontra em externo()</span>
    console.log(nivel1)   <span class="syn-comment">// sobe dois níveis — encontra no global</span>
  }
...
<span class="syn-comment">// console.log(nivel3)  → ReferenceError</span></code></pre>
  ...
  <div class="code-console">
    <div class="code-console__line">
      ...
      <span class="code-console__arrow">→</span>
      <span class="syn-output">"interno"</span>
    </div>
    ...
    <div class="code-console__line">
      ...
      <span class="code-console__arrow">→</span>
      <span class="syn-output">"externo"</span>
    </div>
    ...
    <div class="code-console__line">
      ...
      <span class="code-console__arrow">→</span>
      <span class="syn-output">"global"</span>
    </div>
  </div>
</section>
...
<span class="syn-keyword">function</span> <span class="syn-fn">processarPedido</span>() {
  <span class="syn-keyword">const</span> status = <span class="syn-string">"pendente"</span>   <span class="syn-comment">// shadowa o global</span>

  console.log(status)   <span class="syn-comment">// "pendente" — motor encontra aqui e para</span>
}

processarPedido()
console.log(status)   <span class="syn-comment">// "ativo" — fora da função, o global continua intacto</span></code></pre>
  </div>
  ...
  <div class="code-console">
    <div class="code-console__line">
      ...
      <span class="code-console__arrow">→</span>
      <span class="syn-output">"pendente"</span>
    </div>
    ...
    <div class="code-console__line">
      ...
      <span class="code-console__arrow">→</span>
      <span class="syn-output">"ativo"</span>
    </div>
  </div>
...
<section class="lesson__section">
  ...
  <span class="syn-keyword">if</span> (itens.length > <span class="syn-number">0</span>) {
    <span class="syn-keyword">var</span> totalVar = itens.length       <span class="syn-comment">// var — vaza para a função</span>
    <span class="syn-keyword">const</span> totalConst = itens.length   <span class="syn-comment">// const — fica no bloco</span>
  }

  console.log(totalVar)    <span class="syn-comment">// 3 — var vazou do bloco if</span>
  console.log(totalConst)  <span class="syn-comment">// ReferenceError — const ficou no bloco</span>
}

processar([<span class="syn-string">"a"</span>, <span class="syn-string">"b"</span>, <span class="syn-string">"c"</span>])</code></pre>
  </div>
